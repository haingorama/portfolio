...
class ContentItem {
      ...
      toggleCurrent() {
          this.DOM.el.classList[this.DOM.el.classList.contains('portfolio--content__item--current') ? 'remove' : 'add']('portfolio--content__item--current');
      }
  }
  ...
  class NavController {
    ...
    // The content items instances.
          this.contentItems = [];
          Array.from(this.DOM.page.querySelectorAll('.portfolio--content > .portfolio--content__item')).forEach((item) => this.contentItems.push(new ContentItem(item)));
          // The grid instances.
          this.grids = [];
